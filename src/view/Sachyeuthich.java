...
public class Sachyeuthich extends javax.swing.JFrame {
    ...
    public void Thongke(String from, String to) {
        try {
            Connection con = Database.getConnection();
                        ...
                        String sql1 = "SELECT s.tensach, COUNT(*) AS borrowCount FROM ChitietMt ct "
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sachyeuthich().setVisible(true);
            }
        });
    }
